    ...
    <main className="min-h-screen p-4 md:p-8 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-row flex-wrap gap-4 my-6">
          ...
          <div className="flex-1 min-w-[180px] bg-white rounded-lg shadow p-4 border border-gray-200">
            <h3 className="text-sm font-medium text-gray-500">Rented (Paid)</h3>
          ...
          <div className="flex-1 min-w-[180px] bg-white rounded-lg shadow p-4 border border-gray-200">
            <h3 className="text-sm font-medium text-gray-500">Rented (Unpaid)</h3>
                ...
                <g key={shop.id}>
                  ...
                  <text
                    ...
                    style={{
                      ...
                      fontWeight: 'normal',
                      fontSize: '12px',
                      textShadow: '0 0 4px rgba(0,0,0,0.8), 0 0 4px rgba(0,0,0,0.8)',
